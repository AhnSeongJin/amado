                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="${contextPath}/resources/img/product-img/pro-big-1.jpg">
                                            <img class="d-block w-100" src="${contextPath}/resources/img/product-img/pro-big-1.jpg" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="${contextPath}/resources/img/product-img/pro-big-2.jpg">
                                            <img class="d-block w-100" src="${contextPath}/resources/img/product-img/pro-big-2.jpg" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="${contextPath}/resources/img/product-img/pro-big-3.jpg">
                                            <img class="d-block w-100" src="${contextPath}/resources/img/product-img/pro-big-3.jpg" alt="Third slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="${contextPath}/resources/img/product-img/pro-big-4.jpg">
                                            <img class="d-block w-100" src="${contextPath}/resources/img/product-img/pro-big-4.jpg" alt="Fourth slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
